...
module.exports={
    ...
    "formats": {
        "date": "{{=it.day}}. {{=it.monthName}} {{=it.year}}"
    },

    "daily": {
        "each": "Jeden Tag",
        "some": "Jeden {{=it.weekDays}}"
    },

    "weekly": {
        "each": "Jede Woche",
        "interval": "Jede {{=it.interval}}. Woche"
    },

    "monthly": {
        "each": "Jeden Monat",
        "interval": "Jeden {{=it.interval}}. Monat"
    },

    "yearly": {
        "each": "Jedes Jahr",
        "interval": "Jedes {{=it.interval}}. Jahr"
    },

    "seriesEnd": {
        "occurances": "endet nach {{=it.number}} Veranstaltungen",
        "date": "endet am {{=it.date}}"
    }
}
...
},{"dot":36}],3:[function(require,module,exports){
...
},{"./doT":35,"fs":37}],37:[function(require,module,exports){
...
},{"../i18n/de_de.json":1,"../index":2,"chai":3}]},{},[41])